...
static defaultProps = {
	...
	onLayout: undefined,
	onCancel: undefined,
	onRejectImage: undefined,
	onAcceptImage: undefined,
	onPictureTaken: undefined,
	onPictureProcessed: undefined,
...
constructor(props: IProps) {
	log(DEBUG,'constructor','',logParms);
	super(props);
	this.state = {
		flashEnabled: false,
...
getPreviewSize() {
	...
	// Landscape (this app does not support landscape)
	return {
